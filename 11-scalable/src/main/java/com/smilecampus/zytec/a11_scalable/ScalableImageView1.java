 ...
 */
public class ScalableImageView1 extends View {
    ...
    float currentScale;//0 ~1f 0 smallScale 1 bigScale
    ...
    public ScalableImageView1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float scakeFraction = (currentScale - smallScale) / (bigScale - smallScale);
        //方法1 将双击方法的图片 然后拖拽 然后缩小回到原点 然后在缩放动画中添加动画监听
        canvas.translate(offsetX * scakeFraction, offsetY * scakeFraction);
//        float scale = big ? bigScale : smallScale;
        //需要方法多少
        canvas.scale(currentScale, currentScale, getWidth() / 2f, getHeight() / 2);
...
//            post(this);
                ...
                ViewCompat.postOnAnimation(ScalableImageView1.this, this);
            }
        }
    }
